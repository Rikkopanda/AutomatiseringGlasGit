...
# uncomment to see raw bytes going out/coming back on the wire --
# useful for confirming the script is actually transmitting when
# you're troubleshooting a "no response" error
# logging.basicConfig()
