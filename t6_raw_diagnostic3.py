...
# manual's own worked example: servo enable, slave ID 17 (this drive's actual
# configured address, confirmed by the scan finding a valid reply from ID 17)
FRAME = bytes.fromhex("11 06 20 09 00 01 91 58".replace(" ", ""))
